...
export default function Hero() {
	...
	return (
		<div className="w-[90%] xs:w-[95%] mx-auto m-5 flex items-center justify-center pt-32 xs:pt-44 lg:pt-0 lg:h-screen">
			<div
				...
				<div className="pr-4 sm:pr-5 lg:pr-10">
					...
					<div className="flex gap-2 xs:gap-3 sm:gap-4 lg:gap-7 mt-8 md:mt-10 lg:mt-12">
						...
						>
							...
							<span className="relative z-10 text-sm xs:text-[11px] sm:text-xs lg:text-sm">Watch Demo</span>
						...
						>
							...
							<span className="relative z-10 text-sm xs:text-[11px] sm:text-xs lg:text-sm">Explorer</span>
							<div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl blur-sm"></div>
						</Link>
					</div>
				</div>
				<div className="hidden xs:block p-3 sm:p-5 pt-0 sm:pt-2 md:pt-0 lg:p-10 border-l border-secondary w-1/2 text-justify">
