...
export default function SettingsForm() {
	...
	const componentCode = `...component code here...`;
	...
	function renderInput(label: string, placeholder: string, helperText: string) {
		return (
			<label className="flex flex-col text-primary gap-2 pt-6">
				{label}
				<input
					...
					className="bg-primary outline-none border border-neutral-600 py-2 px-4 rounded-lg text-sm"
				/>
				<span className="text-neutral-400 text-xs">{helperText}</span>
			</label>
		);
	}
